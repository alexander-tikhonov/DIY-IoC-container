...
import com.tikhonov.models.DivisionEquation;
import com.tikhonov.models.Equation;
import com.tikhonov.models.MultiplicationEquation;
...
public class EquationPreparerImpl implements EquationPreparer {
    ...
    public List<Equation> prepareEquationsFor(int base) {
        ...
        for (int i = 1; i < 11; i++) {
            ...
            var divisionEquation = new DivisionEquation(multiplicationEquation.getResult(), i);
